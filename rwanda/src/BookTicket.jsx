...
import { FaCarSide, FaMapMarkerAlt, FaPaperPlane, FaRegClock, FaCreditCard } from "react-icons/fa";
import './BookRide.css';
...
export default function BookRide() {
  ...
  return (
    <div style={{ background: '#fff', minHeight: '100vh', width: '100vw' }}>
      <Logbar />
      <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '2rem', marginTop: '2rem', marginBottom: '2rem', fontFamily: 'inherit' }}>
        Book Your Ride In Rwanda
      </div>
      <div className="main-content-container" style={{ display: 'flex', gap: '2rem', justifyContent: 'center', marginTop: '48px', minHeight: '100vh', overflowY: 'visible' }}>
